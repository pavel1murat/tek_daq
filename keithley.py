...
#
import sys, time, numpy, fileinput, argparse
...
class Keithley2231:
    ...
    def run_diagnostics(self):
        ...
        # disable CH1 output
        #self._dev.write("output disable");
        #self._dev.write("chan:output 1");
...
if __name__ == '__main__':
    ...
    """
    BUG- if below functions are called in main, garbage collection order
       causes errors. Functions are now called in setup().
